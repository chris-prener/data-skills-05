...
nyt <- read_csv(here("data", "resources", "nyt_usa_covid_raw.csv"))
...
write_csv(nyt, here("data", "nyt_usa_covid_wide.csv"))
write_csv(nyt_long, here("data", "nyt_usa_covid_long.csv"))
